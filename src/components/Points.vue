  ...
  <div>
    ...
    <div class="buyables">
      <div class="buyable">
        ...
        <p
          class="buyableCost"
          v-if="points.buyables.buyable1Amount < pointsStatsCalculated.buyables.buyable1.maxAmount"
        >
        ...
        <div
          ...
          v-if="points.buyables.buyable1Amount < pointsStatsCalculated.buyables.buyable1.maxAmount"
        >
          <div class="buyableBuyOne" :class="{'buyablePurchaseable': points.amount>=pointsStatsCalculated.buyables.buyable1.cost}" @click="Buyable1BuyOnce">Buy 1</div>
          <div class="buyableBuyMax" :class="{'buyablePurchaseable': points.amount>=pointsStatsCalculated.buyables.buyable1.cost}" @click="Buyable1BuyMax">Buy Max</div>
        </div>
      </div>
      ...
      <div class="buyable">
        ...
        <p
          class="buyableCost"
          v-if="points.buyables.buyable2Amount < pointsStatsCalculated.buyables.buyable2.maxAmount"
        >
        ...
        <div
          ...
          v-if="points.buyables.buyable2Amount < pointsStatsCalculated.buyables.buyable2.maxAmount"
        >
          <div class="buyableBuyOne" :class="{'buyablePurchaseable': points.amount>=pointsStatsCalculated.buyables.buyable2.cost}" @click="Buyable2BuyOnce">Buy 1</div>
          <div class="buyableBuyMax" :class="{'buyablePurchaseable': points.amount>=pointsStatsCalculated.buyables.buyable2.cost}" @click="Buyable2BuyMax">Buy Max</div>
        </div>
      </div>
    </div>
  </div>
...
const Buyable1BuyOnce=()=>{
  ...
  if(points.amount>=pointsStatsCalculated.buyables.buyable1.cost){
    ...
    points.buyables.buyable1Amount++
    pointsStatsCalculated.buyables.buyable1.cost=10*Math.pow(2, points.buyables.buyable1Amount * (1 + Math.log2(points.buyables.buyable1Amount)))
    pointsStatsCalculated.buyables.buyable1.effects.effectOnPoints.multiplier=Math.pow(2, points.buyables.buyable1Amount)
  }
}
...
const Buyable2BuyOnce=()=>{
  if(points.amount>=pointsStatsCalculated.buyables.buyable2.cost){
    ...
    points.buyables.buyable2Amount++
    pointsStatsCalculated.buyables.buyable2.cost=25*Math.pow(1.35, points.buyables.buyable2Amount * (1 + Math.log2(points.buyables.buyable2Amount)))
    pointsStatsCalculated.buyables.buyable2.effects.effectOnPoints.multiplier=(1 + points.buyables.buyable2Amount) * Math.max(1, 2 * Math.floor(points.buyables.buyable2Amount /25))
  }
}
