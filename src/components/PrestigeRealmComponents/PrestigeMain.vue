  ...
  <div>
    ...
    <div class="layerMenu">
      <div class="layerSubMenu">
        <div class="subMenuItem" :class="{'selectedSubMenuItem' : isPrestigeUpgradesToggled}" @click="TogglePrestigeUpgrades">
          <h2>Upgrades</h2>
        </div>
        <div class="subMenuItem" :class="{'selectedSubMenuItem' : isPrestigeMilestonesToggled}" @click="TogglePrestigeMilestones">
          <h2>Milestones</h2>
        </div>
      </div>
      <div class="main">
